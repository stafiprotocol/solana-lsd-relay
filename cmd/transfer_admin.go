...
func stakeManagerTransferAdminCmd() *cobra.Command {
	...
	var cmd = &cobra.Command{
		...
		Out:
			...
			transferAdminInstruction := lsd_program.NewTransferStakeManagerAdminInstruction(
				newAdminPubkey,
				stakeManagerPubkey,
				adminPubkey,
			).Build()
			...
			_, err = adminExecuteInstructions("transfer balancer", rpcClient, []solana.Instruction{transferAdminInstruction}, cfg.KeystorePath, feePayerPubkey, adminPubkey, exportTxMessage)
			return err
		},
	}

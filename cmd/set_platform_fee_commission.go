...
func stakeManagerSetPlatformFeeCommissionCmd() *cobra.Command {
	...
	var cmd = &cobra.Command{
		...
		Out:
			...
			_, err = adminExecuteInstructions("set min stake amount", rpcClient, []solana.Instruction{setPlatformFeeCommissionInstruction}, cfg.KeystorePath, feePayerPubkey, adminPubkey, exportTxMessage)
			return err
		},
	}

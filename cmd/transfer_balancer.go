...
func stakeManagerTransferBalancerCmd() *cobra.Command {
	...
	var cmd = &cobra.Command{
		...
		Out:
			...
			_, err = adminExecuteInstructions("transfer balancer", rpcClient, []solana.Instruction{transferBalancerInstruction}, cfg.KeystorePath, feePayerPubkey, adminPubkey, exportTxMessage)
			return err
		},
	}

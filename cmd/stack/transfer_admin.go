...
func TransferAdminCmd() *cobra.Command {
	...
	var cmd = &cobra.Command{
		...
		Out:
			...
			transferAdminInstruction := stack.NewTransferStackAdminInstruction(
				newAdminPubkey,
				stackPubkey,
				adminPubkey,
			).Build()

			_, err = common.AdminExecuteInstructions("transfer admin", rpcClient, []solana.Instruction{transferAdminInstruction}, cfg.KeystorePath, feePayerPubkey, adminPubkey, cfg.ExportTx)
			return err
		},
	}

...
func (inst *EraNew) SetClockAccount(clock ag_solanago.PublicKey) *EraNew {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(clock)
	return inst
}

// GetClockAccount gets the "clock" account.
func (inst *EraNew) GetClockAccount() *ag_solanago.AccountMeta {
			...
			programBranch.Child(ag_format.Instruction("EraNew")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=2]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("       clock", inst.AccountMetaSlice.Get(1)))
					})
				})
		})
}
...
func NewEraNewInstruction(
	...
	clock ag_solanago.PublicKey) *EraNew {

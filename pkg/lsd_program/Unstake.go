...
func (inst *Unstake) SetClockAccount(clock ag_solanago.PublicKey) *Unstake {
	inst.AccountMetaSlice[8] = ag_solanago.Meta(clock)
	return inst
}

// GetClockAccount gets the "clock" account.
func (inst *Unstake) GetClockAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetRentAccount sets the "rent" account.
func (inst *Unstake) SetRentAccount(rent ag_solanago.PublicKey) *Unstake {
	inst.AccountMetaSlice[9] = ag_solanago.Meta(rent)
	return inst
}

// GetRentAccount gets the "rent" account.
func (inst *Unstake) GetRentAccount() *ag_solanago.AccountMeta {
...
func NewUnstakeInstruction(
	...
	rent ag_solanago.PublicKey) *Unstake {

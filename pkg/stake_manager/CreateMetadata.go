...
func (inst *CreateMetadata) SetStakePoolAccount(stakePool ag_solanago.PublicKey) *CreateMetadata {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(stakePool).WRITE()
	return inst
}

// GetStakePoolAccount gets the "stakePool" account.
func (inst *CreateMetadata) GetStakePoolAccount() *ag_solanago.AccountMeta {
...
func (inst *CreateMetadata) SetMetadataProgramAccount(metadataProgram ag_solanago.PublicKey) *CreateMetadata {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(metadataProgram)
	return inst
}
...
func (inst *CreateMetadata) SetSysvarInstructionAccount(sysvarInstruction ag_solanago.PublicKey) *CreateMetadata {
	inst.AccountMetaSlice[9] = ag_solanago.Meta(sysvarInstruction)
	return inst
}
			...
			programBranch.Child(ag_format.Instruction("CreateMetadata")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=10]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("  metadataProgram", inst.AccountMetaSlice.Get(7)))
						accountsBranch.Child(ag_format.Meta("    systemProgram", inst.AccountMetaSlice.Get(8)))
						accountsBranch.Child(ag_format.Meta("sysvarInstruction", inst.AccountMetaSlice.Get(9)))
					})
				})
		})
}

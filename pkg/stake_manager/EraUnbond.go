...
func (inst *EraUnbond) SetStakeHistoryAccount(stakeHistory ag_solanago.PublicKey) *EraUnbond {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(stakeHistory)
	return inst
}
...
func (inst *EraUnbond) SetStakeProgramAccount(stakeProgram ag_solanago.PublicKey) *EraUnbond {
	inst.AccountMetaSlice[8] = ag_solanago.Meta(stakeProgram)
	return inst
}
			...
			programBranch.Child(ag_format.Instruction("EraUnbond")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=10]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta(" stakeHistory", inst.AccountMetaSlice.Get(7)))
						accountsBranch.Child(ag_format.Meta(" stakeProgram", inst.AccountMetaSlice.Get(8)))
